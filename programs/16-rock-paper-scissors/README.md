...
## Explanation
Choices are encoded as 0, 1, 2. The three winning combinations for the user are checked explicitly against the computer's random pick.
