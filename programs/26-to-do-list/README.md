...
**Concepts:** Vectors, Structs

## Description
Add, complete and remove tasks from a simple to-do list.
...
## Explanation
Each Task struct stores its text and a done flag. vector::erase removes a task by its position when the user chooses to delete it.
